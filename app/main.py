...
app.add_middleware(SessionMiddleware, secret_key=settings.WEB_SESSION_SECRET or settings.ADMIN_WEB_SECRET, same_site="lax", https_only=False)
...
@app.get("/")
async def root():
    return {"ok": True, "service": "Jelly Follow API", "version": "1.3.0",
