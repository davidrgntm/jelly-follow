...
from app.services.employees_service import register_employee, get_employee_by_id, get_employee_stats
...
async def api_register(payload: RegisterPayload):
    return register_employee(
        telegram_user_id=payload.telegram_user_id, telegram_username=payload.telegram_username,
