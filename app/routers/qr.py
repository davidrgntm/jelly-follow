...
async def api_gen_employee_qr(employee_id: str, x_internal_secret: str = Header("")):
    ...
    return generate_employee_qr(employee_id, emp["employee_code"], emp["country_code"])
...
async def api_gen_event_qr(employee_id: str, event_id: str, x_internal_secret: str = Header("")):
    ...
    if not emp:
        raise HTTPException(status_code=404, detail="Employee not found")
    return generate_event_qr(employee_id, emp["employee_code"], event_id, emp["country_code"])
