...
def main_menu_keyboard(lang="uz", is_admin=False, qr_webapp_url: str = ""):
    qr_button = KeyboardButton(text=t("menu.my_qr", lang))
    if qr_webapp_url:
        qr_button = KeyboardButton(text=t("menu.my_qr", lang), web_app=WebAppInfo(url=qr_webapp_url))

    rows = [
        [KeyboardButton(text=t("menu.profile", lang)), qr_button],
